...
class compte_annuel(report_sxw.rml_parse):
...
report_sxw.report_sxw('report.reportevi.compte.annuel', 'account.account', 'addons/reportevi/report/compte_annuel.rml', parser=compte_annuel, header=False)
