...
class compteannuel(report_sxw.rml_parse):
	def __init__(self, cr, uid, name, context):
		super(compte_annuel, self).__init__(cr, uid, name, context)
	...
	def lines(self, account, form):
		...
		self.cr.execute("SELECT l.date, j.code, l.ref, l.name, l.debit, l.credit "\
			...
			" and ((l.debit <>0) or (l.credit<>0)) ORDER by l.id", (account.id,))
...
report_sxw.report_sxw('report.reportevi.compteannuel', 'reportevi.compte.annuel', 'addons/reportevi/report/compte_annuel.rml', parser=compteannuel, header=False)
