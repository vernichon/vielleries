...
class balanceclients(report_fr_rml_parse):
	totalclasse={}
	
	def __init__(self, cr, uid, name, context):
		super(balanceclients, self).__init__(cr, uid, name, context)
...
report_sxw.report_sxw('report.report.account.fr.balanceclients', 'report.account.fr.lignes','addons/report_account_fr/report/balanceclientsclients.rml', parser=balanceclients,header=True)
