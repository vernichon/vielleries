...
class ims_contrat(osv.osv):
	...
	_columns = {
		...
		'site':fields.one2many('ims.site', 'contract_id','Site'),	
...
class ims_site(osv.osv):
	...
	_columns = {
		...
		'mouvement':fields.one2many('stock.move', 'site_id','Site'),
	}
ims_site()
...
class crm_case_history(osv.osv):
	...
	_columns = {
		'duree':fields.char('Duree d''intervetion', size=128),
	}
crm_case_history()
