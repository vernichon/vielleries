...
class wizard_valider(wizard.interface):
    states = {
        'init': {
            'actions': [_init],
            'result': {'type':'form', 'arch':valider_form, 'fields':valider_fields, 'state':[('end','Cancel'),('valider','Valider')]}
        },
        'valider': {
            'actions': [_valider],
